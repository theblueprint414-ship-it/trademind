...
const BROKER_INTEGRATIONS = [
  ...
  { name: "Bybit", tag: "LIVE", note: "Direct API — full trade history with entry & exit prices", color: "var(--green)" },
  { name: "Alpaca", tag: "LIVE", note: "Direct API — US stocks & crypto, auto-sync daily P&L", color: "var(--green)" },
  { name: "Binance", tag: "LIVE", note: "Direct API — spot & futures trade history", color: "var(--green)" },
  ...
  { name: "Interactive Brokers", tag: "CSV", note: "Export trade history from TWS → import via CSV", color: "#60A5FA" },
  { name: "cTrader", tag: "CSV", note: "Export positions from cTrader → import via CSV", color: "#60A5FA" },
];
...
const STACK = [
  ...
  },
  {
    category: "Payments",
    items: [
      { name: "LemonSqueezy", role: "PCI DSS Level 1 compliant billing — card data never touches our servers" },
    ],
  },
  {
    category: "Database",
