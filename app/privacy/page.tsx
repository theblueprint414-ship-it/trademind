...
f) Payment data: Handled entirely by LemonSqueezy. TradeMind does not store, process, or have access to your full payment card details.
...
• LemonSqueezy Inc. (payment processing) — lemonsqueezy.com/privacy — LemonSqueezy is PCI DSS Level 1 certified and handles all billing data
...
Each of these services has its own privacy policy. We recommend reviewing them. We do not use advertising networks, social tracking pixels, or data brokers.`,
  ...
  },
  {
    ...
    body: `We retain your data for as long as your account is active. If you delete your account, all associated data (check-ins, journal entries, analytics, broker credentials, playbook rules) is permanently and irrecoverably deleted from our systems within 30 days. Aggregated, anonymized usage statistics that cannot identify you may be retained indefinitely. LemonSqueezy retains billing records as required by applicable tax and financial regulations.`,
  },
  {
