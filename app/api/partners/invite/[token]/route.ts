...
// GET /api/partners/invite/[token] — get invite details (for accept page)
...
// PATCH /api/partners/invite/[token] — accept or decline
export async function PATCH(
  ...
  // If invite was targeted to a specific email, enforce it; otherwise (WhatsApp invite) anyone can accept
  ...
  // Require at least Pro to be a partner
  ...
  if (action === "accept") {
    // Create a bidirectional partnership (ensure consistent ordering)
