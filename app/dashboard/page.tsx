          ...
          <div className="quick-grid">
            {([
              ...
              },
              {
                ...
                chip: monthlyCount > 0 ? { label: `${monthlyCount} this month`, color: "var(--green)" } : null,
              },
              {
                href: "/analytics",
                ...
                chip: avg7 !== null ? { label: `${avg7} avg`, color: avg7Color } : null,
              },
              {
                href: "/playbook",
              ...
              {
                href: "/mind",
                icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9.5 3C6.5 3 4 5.5 4 8.5c0 2.3 1.4 4.3 3.5 5.2V19a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1v-5.3c2.1-.9 3.5-2.9 3.5-5.2C20 5.5 17.5 3 14.5 3H9.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/></svg>,
                label: "Mind Patterns",
                sub: "Sleep, caffeine & performance",
                color: "#A78BFA", hex: "#A78BFA",
                chip: null,
              },
              {
                href: "/setup-library",
                icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M4 6h16M4 12h10M4 18h13" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/><circle cx="19" cy="18" r="2.5" stroke="currentColor" strokeWidth="1.5"/></svg>,
                label: "Setup Library",
                sub: "ICT / SMC reference guide",
                color: "#60A5FA", hex: "#60A5FA",
                chip: { label: "9 setups", color: "#60A5FA" },
              },
              {
                href: "/pretrade",
                icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9 11l3 3L22 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/></svg>,
                label: "Pre-Trade",
