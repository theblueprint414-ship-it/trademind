...
const RELEASES: { version: string; date: string; entries: Entry[] }[] = [
  {
    ...
    date: "Apr 22–26, 2026",
    entries: [
      { date: "Apr 26", tag: "NEW", title: "Morning Brief on Dashboard", body: "The dashboard now surfaces one personalised insight every morning: your 3-day score trend, your historically sharpest day of the week, and (for Premium users) your exercise-score correlation. No extra API call — derived from your existing data." },
      ...
      { date: "Apr 26", tag: "NEW", title: "Lifestyle correlation strip (Premium)", body: "Premium dashboard now shows a live strip comparing your average score on exercise days vs rest days, with the point-lift delta and a link to the full analytics page." },
  ...
  },
  {
    ...
    entries: [
      ...
      { date: "Apr 22", tag: "NEW", title: "Prop Firm Challenge Tracker", body: "Premium users can now enable Challenge Mode. Set your account size, daily loss limit, max drawdown, and profit target. The tracker displays live P&L from your connected broker and alerts you as you approach limits." },
  ...
  },
  {
    ...
    date: "Apr 16–20, 2026",
    entries: [
      { date: "Apr 20", tag: "NEW", title: "AI Coach Alex (Premium)", body: "Premium users get access to Alex, an AI coach that analyses your check-in history, journal entries, and P&L to surface the specific behavioural patterns costing you money — and gives you one concrete thing to change. Weekly insights are cached to avoid repeat questions." },
      ...
      { date: "Apr 19", tag: "NEW", title: "90-day analytics heatmap (Pro)", body: "The analytics page now includes a full 90-day score heatmap, psychology vs P&L scatter plot, win rate by verdict, and estimated losses avoided on NO-TRADE days." },
      { date: "Apr 19", tag: "NEW", title: "Accountability partners (Pro)", body: "Invite up to 3 trading partners. Each morning, your partners see your mental score and verdict in their dashboard — and vice versa. Mutual visibility drives mutual accountability." },
