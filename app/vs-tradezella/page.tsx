...
const COMPARISON_ROWS = [
  ...
  { feature: "Pre-trade ritual (conviction score + thesis writing)", tm: true, tz: false },
  { feature: "Trade journal with P&L logging", tm: true, tz: true },
  { category: "Psychology & Mental Layer", feature: "Psychology vs P&L correlation chart", tm: true, tz: false },
  { feature: "Behavioral pattern detection (revenge, FOMO, overtrading)", tm: true, tz: false },
  { feature: "Lifestyle × performance correlation (sleep, caffeine, alcohol, exercise)", tm: true, tz: false },
  { feature: "Mental Patterns Dashboard — auto-generated insights", tm: true, tz: false },
  { feature: "Mid-session pulse check-in", tm: true, tz: false },
  ...
  { feature: "Equity curve + max drawdown", tm: true, tz: true },
  { feature: "Best hours / best days heatmap", tm: true, tz: true },
  { feature: "Symbol performance table", tm: true, tz: true },
  { feature: "Profit factor, expectancy, R-multiple", tm: true, tz: true },
  { feature: "Trade replay on chart (animated)", tm: true, tz: true },
  { feature: "Advanced backtesting", tm: false, tz: true },
  { feature: "MAE/MFE entry/exit analysis", tm: false, tz: "partial" },
  { category: "ICT / Smart Money Concepts", feature: "ICT/SMC setup tagging on every trade (FVG, OB, BOS, ChoCh…)", tm: true, tz: false },
  { feature: "Built-in ICT/SMC reference library (9 setups with full trade instructions)", tm: true, tz: false },
  { feature: "Setup performance — which SMC setup makes you the most money", tm: true, tz: false },
  ...
  { feature: "Drawdown proximity alerts", tm: true, tz: false },
  ...
  { feature: "Weekly AI-generated review", tm: true, tz: false },
  { category: "Desktop Sync", feature: "Direct MT4/MT5 Expert Advisor sync (no MetaAPI needed)", tm: true, tz: false },
  { feature: "NinjaTrader 8 direct database sync", tm: true, tz: false },
  { feature: "Tradovate CSV folder auto-sync", tm: true, tz: false },
  { feature: "Broker API auto-sync (MT4/5, Bybit, Alpaca, Binance, TopstepX)", tm: true, tz: true },
  { category: "Platform", feature: "Mobile-first design + PWA", tm: true, tz: false },
  { feature: "Streak tracking + gamification", tm: true, tz: false },
  { feature: "Push notifications (circuit breaker, streak, check-in)", tm: true, tz: false },
];
