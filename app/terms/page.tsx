...
const sections = [
  ...
  },
  {
    ...
    body: `TradeMind includes a 7-day free trial. You will not be charged during the trial period. If you do not cancel before the trial ends, your subscription will automatically begin billing at $39/month (or $29/month on the annual plan), processed by LemonSqueezy. By providing payment information, you authorize LemonSqueezy to charge you on a recurring basis. All charges after the free trial are final. We do not offer refunds except where required by applicable law. You may cancel your subscription at any time through Settings; cancellation takes effect at the end of the current billing period. Annual pricing is non-refundable after the trial period. For billing disputes, contact support@trademindedge.com.`,
  },
  {
